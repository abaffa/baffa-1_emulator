...
BAFFA1_MEMORY::BAFFA1_MEMORY()
{
	...
	int i = 0;
	this->mem_bios = (BAFFA1_BYTE*)malloc(BAFFA1_BIOS_MEMORY_SIZE * sizeof(BAFFA1_BYTE));

	this->mem_page_table0 = (BAFFA1_BYTE*)malloc(BAFFA1_PAGING_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->mem_page_table1 = (BAFFA1_BYTE*)malloc(BAFFA1_PAGING_MEMORY_SIZE * sizeof(BAFFA1_BYTE));

	this->low_memory = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));

	this->high_memory0 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->high_memory1 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->high_memory2 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->high_memory3 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->high_memory4 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->high_memory5 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->high_memory6 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
	this->high_memory7 = (BAFFA1_BYTE*)malloc(BAFFA1_MAIN_MEMORY_SIZE * sizeof(BAFFA1_BYTE));
...
void BAFFA1_MEMORY::reset()
{
	...
	for (address = 0; address < BAFFA1_BIOS_MEMORY_SIZE; address++) {
		this->mem_bios[address] = 0x00;
	}
	for (address = 0; address < BAFFA1_PAGING_MEMORY_SIZE; address++) {
		this->mem_page_table0[address] = 0x00;
		this->mem_page_table1[address] = 0x00;
	}
	for (address = 0; address < BAFFA1_MAIN_MEMORY_SIZE; address++) {
...
void BAFFA1_MEMORY::displayBiosMemory(BAFFA1_REGISTERS& registers, HW_TTY& hw_tty)
{
	char str_out[255];
	int i = 0;
...
void BAFFA1_MEMORY::displayLowMemory(BAFFA1_REGISTERS& registers, HW_TTY& hw_tty)
{
	char str_out[255];
	int i = 0;
	BAFFA1_DWORD MAR = BAFFA1_REGISTERS::value(registers.MARl, registers.MARh);
...
void BAFFA1_MEMORY::displayMemory(BAFFA1_BYTE* mem_bytes, int offset, BAFFA1_MWORD MAR, HW_TTY& hw_tty)
{
	char str_out[255];
	int i = 0, j = 0;
